...
public class ClientNaiveAgentCrazyLoadLevel implements Runnable {
	 ...
	 * */
	public ClientNaiveAgentCrazyLoadLevel() {
	 ...
	 * */
	public ClientNaiveAgentCrazyLoadLevel(String ip) {
	...
	public ClientNaiveAgentCrazyLoadLevel(String ip, int id)
	{
		ar = new ClientActionRobotJava(ip);
		tp = new TrajectoryPlanner();
		randomGenerator = new Random();
	...
	public static void main(String args[]) {
		...
		ClientNaiveAgentCrazyLoadLevel na;
		if(args.length > 0)
			na = new ClientNaiveAgentCrazyLoadLevel("127.0.0.1", Integer.parseInt(args[0]));
		else
			na = new ClientNaiveAgentCrazyLoadLevel();
		na.run();
